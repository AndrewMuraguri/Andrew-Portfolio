...
export function Project() {
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href='https://andrewmuraguri.github.io/RoboFriend/'><button class="live"><img src={require('../media/icons8-website-50.png')} alt='website'></img></button></a>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="user">
        ...
        <a href='https://andrewmuraguri.github.io/'><button class="live"><img src={require('../media/icons8-website-50.png')} alt='port'></img></button></a>
